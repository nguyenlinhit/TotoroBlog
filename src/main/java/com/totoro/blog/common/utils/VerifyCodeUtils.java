...
public class VerifyCodeUtils {
    ...
    /**
     * Algerian fonts are used. If not available in the system,
     * fonts need to be installed. The fonts are only displayed in uppercase,
     * and 1,0, i, o characters are easily removed.
     */
